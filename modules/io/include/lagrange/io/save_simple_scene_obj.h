...
/**
 * Save a simple scene to an obj file. Some information about the scene will be lost,
 * as the obj format does not support all scene features.
 *
...
LA_IO_API void save_simple_scene_obj(
