...
LA_IO_API MeshType load_mesh_msh(std::istream& input_stream, const LoadOptions& options = {});
 ...
 */
template <typename MeshType>
LA_IO_API MeshType load_mesh_msh(const fs::path& filename, const LoadOptions& options = {});
