...
private:
    ...
    void set_toggle(bool LGUI_UNUSED(val), T LGUI_UNUSED(discard_val), Args... LGUI_UNUSED(args))
    {}

    void set_toggle(bool LGUI_UNUSED(val)) {}

    // Discard extra parameters
    template <class... Args>
    void set_toggle(bool val, GLenum name, Args... LGUI_UNUSED(args))
    {
        set_toggle(val, name);
    }
    template <class... Args>
    void set_toggle(bool val, int name, Args... LGUI_UNUSED(args))
    {
