...
#include <lagrange/raycasting/legacy/project_attributes_closest_point.h>
...
void project_attributes_directional(
    ...
    FallbackMode wrap_mode = FallbackMode::Constant,
    ...
    std::function<bool(IndexOf<TargetMeshType>)> skip_vertex = nullptr)
{
    ...
    if (wrap_mode != FallbackMode::Constant) {
