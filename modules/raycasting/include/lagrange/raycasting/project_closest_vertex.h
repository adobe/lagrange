...
/// vertex on the source mesh surface. The closest surface point is found via a closest-point query,
/// then snapped to the nearest vertex of the hit triangle (the vertex with the largest barycentric
/// weight).
///
...
LA_RAYCASTING_API void project_closest_vertex(
