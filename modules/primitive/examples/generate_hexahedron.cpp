...
int main(int argc, char** argv)
{
    ...
    setting.width = args.radius * 2;
    setting.height = args.radius * 2;
    setting.depth = args.radius * 2;
    auto mesh = lagrange::primitive::generate_rounded_cube<Scalar, Index>(setting);
