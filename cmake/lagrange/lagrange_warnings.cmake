...
function(lagrange_add_warnings target)
    get_target_property(target_type ${target} TYPE)
    if(target_type STREQUAL "INTERFACE_LIBRARY")
        if(LAGRANGE_PROPAGATE_WARNINGS)
            target_link_libraries(${target} INTERFACE lagrange::warnings)
        endif()
    else()
        if(LAGRANGE_PROPAGATE_WARNINGS)
            target_link_libraries(${target} PUBLIC lagrange::warnings)
        else()
            target_link_libraries(${target} PRIVATE lagrange::warnings)
        endif()
    endif()
endfunction()
