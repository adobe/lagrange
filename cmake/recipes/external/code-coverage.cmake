...
if(CODE_COVERAGE AND NOT CODE_COVERAGE_ADDED)
  ...
  # Temporary error message until we figure out how to use code coverage with AppleClang
  if(APPLE AND CMAKE_CXX_COMPILER_ID MATCHES "AppleClang")
    message(FATAL_ERROR "Code coverage only works with llvm-clang on macOS. Please set CMAKE_CXX_COMPILER accordingly.")
  endif()
